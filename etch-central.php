 ...
 * Description: Adds a unified Etch admin bar command center with content type tools, detected integrations, resources, and quick links.
 * Version: 1.5.0
...
define('ETCH_CENTRAL_VERSION', '1.5.0');
