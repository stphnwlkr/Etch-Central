...
- Fixed Flowguard-style admin interface not loading on some installations.
- Fixed Content Type Menu settings not persisting correctly.
- Fixed checkbox state synchronization when enabling and disabling content types.
- Fixed custom post type menu activation/deactivation logic.
- Improved settings save reliability.
- Improved admin page registration and asset detection.
